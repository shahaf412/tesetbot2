...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("AdventureRP Fivem RolePlay Server IP", "https://i.imgur.com/ew5bl7n.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ AdventureRP Fivem RolePlay' : '⚫ AdventureRP Fivem RolePlay')
    .setTimestamp(new Date())
    .addField('\n\u200b\nHow can you join the server?','Server IP: 185.44.79.55:30120 \n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('AdventureRP Fivem RolePlay',{'url':'https://www.youtube.com/watch?v=kTRzyhltmM8&feature=youtu.be','type':'STREAMING'});
